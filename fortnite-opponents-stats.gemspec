...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Gem that provides real time stats from opponents you are playing ' \
                       'against at a Fortnite match.'
  spec.description   = 'Collect screen captures from your gameplay and parse the opponent ' \
                       'names from the bottom left corner action logs.'
  ...
  spec.bindir        = 'bin'
  spec.executables   = ['fortnite_opponents_stats']
